...
const CrewsServices = () => {
  ...
  const TNC = [
      ...
      content: (
        <>
          ...
          <ol className="list-decimal pl-[25px] py-3">
            ...
            <li>Crew Briefing / Shoot Guidelines Document</li>
            <li>Online Crew Briefing by an experienced global Producer</li>
            <li>Scheduling &amp; Coordination</li>
            <li>Production / Shoot</li>
            <li>Footage Upload to Cloud</li>
            <li>Quality Checks of the Footage</li>
            <li>Footage delivery to you, our client</li>
          </ol>
        </>
      ),
    },
    {
      ...
      content:
        'All the captured footage is uploaded to the cloud and delivered via DropBox, Google Drive or Red BangleX - our creative cloud platform.',
    },
    {
      key: 7,
      ...
      content: (
        <>
          ...
          <a
            onClick={handleClick}
            className="underline cursor-pointer text-rb-red"
          >
            send us a brief
          </a>{' '}
          and we’ll be happy to undertake custom video editing and craft a great
          video for you.We will be able to support any additional requirements
          you may have, such as voice over, music from stock, addition of stock
          or archival footage, graphic design, motion graphics, colour grading
          etc.
        </>
      ),
    },
    {
      ...
      content: (
        <>
          We’ll be happy to throw in a live-stream feed of the production for
          you along with detailed virtual production coordination. You won’t
          miss a thing.{' '}
          <a
            onClick={handleClick}
            className="underline cursor-pointer text-rb-red"
        ...
        <div className="container">
          <div className="flex flex-wrap -mx-4 items-center md:flex-row flex-col gap-8 md:gap-0">
            <div className="w-full md:w-2/5 px-4">
              ...
              <p>
              Our global video crew production service supports your business everywhere you grow. Shoot commercial videos, social media content, customer testimonials, case study videos, recruitment videos, leadership videos and more with our Book a Crew service.
              </p>
