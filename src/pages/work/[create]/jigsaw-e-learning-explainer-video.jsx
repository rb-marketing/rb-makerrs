...
function Colearn() {
    ...
    return (
        <>
            ...
            url="https://www.b2b.redbangle.com/work/campaigns/jigsaw-e-learning-explainer-video"
            />
            <WorkHeroSection
                logo={logo}
                socials={socials}
                ...
                <div className="container">
                    <div className="cs-content max-w-[914px]">
                        ...
                        <div className="mt-6 md:mb-20">
                            ...
                            <p className="mb-6 md:mb-7.5">
                          The ads gave prospective students an overview of the six unique programs offered by Jigsaw and their partners – IIM Indore, Manipal Academy of Higher Education, and NASSCOM. We used a combination of stock footage and images, motion graphics, and voice overs to demonstrate how the curriculum allows individuals to better-prepare for their dream jobs.
                            </p>
