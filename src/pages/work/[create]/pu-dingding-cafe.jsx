    ...
    return (
        <>
            <SEO
                ...
                url="https://www.makerrs.com/work/design/pu-dingding-dessert-cafe-branding"
            />
            <WorkHeroSection
                logo={logo}
                socials={socials}
                ...
                <div className="container">
                    <div className="cs-content max-w-[914px]">
                        ...
                        <div className="relative aspect-auto md:aspect-auto w-[calc(100%_+_2rem)]  md:w-[78.7rem] -mx-4 md:mx-0 md:mt-16">
                            <img src="/img/case-study/puding-banner-2.jpg" alt="lilliacare" srcset="" />
                        </div>
                        ...
                        <div className="mt-9 md:mt-20 md:mb-16">
                            ...
                            <p className="md:text-xl text-rb-black/70 !leading-[170%] mb-9 md:mb-20">
