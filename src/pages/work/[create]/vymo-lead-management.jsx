...
function VymoLeadManagement() {
  ...
  return (
    <>
      ...
      url="https://www.b2b.redbangle.com/work/campaigns/vymo-lead-management"
      />
      <WorkHeroSection
        logo={logo}
        socials={socials}
    ...
    Vymo’s lead management feature helps financial institutions track, nurture, and convert leads with ease. To showcase its impact, we crafted a dynamic marketing video, refining the script, casting with precision, and blending seamless transitions with custom graphics. Produced efficiently in Bangalore with a global appeal, the film delivers a compelling story that resonates with financial teams. We worked closely with the client in enhancing scripts, visualizing in a contextually-relevant manner, and running efficient production workflows throughout the year.
              </p>
